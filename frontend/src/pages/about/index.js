    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/vspend/foodgram-st" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/vspend" className={styles.textLink}>Светлана Пигачева</a>
            </p>
          </div>
        </aside>
      </div>
